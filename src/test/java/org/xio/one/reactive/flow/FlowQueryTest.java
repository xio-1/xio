...
public class FlowQueryTest {
  ...
  public void shouldReturnLastItem() throws InterruptedException {
    ...
    Assert.assertThat(item.getItemValue(), is(3));
  }
  ...
  public void shouldReturnFirstItem() throws InterruptedException {
    ...
    Assert.assertThat(item.getItemValue(), is(1));
  }
  ...
  public void shouldReturnAllItems() throws InterruptedException {
    ...
    Assert.assertThat(items[0].getItemValue(), is(1));
    Assert.assertThat(items[1].getItemValue(), is(2));
    Assert.assertThat(items[2].getItemValue(), is(3));
  }
