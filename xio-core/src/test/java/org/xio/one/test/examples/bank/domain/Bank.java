...
public class Bank {
  ...
  MultiItemSubscriber<Boolean, TransactionRequest> ledgerMultiplexFutureSubscriber;
  ...
  public void open() {
    ...
    transactionLedger.addSubscriber(new MultiItemSubscriber<Boolean, TransactionRequest>() {
      @Override
